        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="tab-payments">
                <div class="row g-4">
                    ...
                    <div class="col-md-6"><div class="glass-card p-4 border-danger h-100"><div class="d-flex justify-content-between mb-3"><h5 class="text-danger"><i class="fa-solid fa-cash-register"></i> FreeKassa</h5><div class="form-check form-switch"><input class="form-check-input" type="checkbox" name="freekassa_enabled" value="1" <?= ($s['freekassa_enabled']??0) ? 'checked' : '' ?>></div></div><input type="text" name="fk_merchant_id" value="<?= htmlspecialchars($s['fk_merchant_id'] ?? '') ?>" class="form-control bg-dark text-light border-secondary mb-2" placeholder="<?= htmlspecialchars($t('admin_settings_merchant_id', 'Merchant ID')) ?>"><input type="password" name="fk_secret_1" value="<?= htmlspecialchars($s['fk_secret_1'] ?? '') ?>" class="form-control bg-dark text-light border-secondary mb-2" placeholder="<?= htmlspecialchars($t('admin_settings_secret_one', 'Secret 1')) ?>"><input type="password" name="fk_secret_2" value="<?= htmlspecialchars($s['fk_secret_2'] ?? '') ?>" class="form-control bg-dark text-light border-secondary" placeholder="<?= htmlspecialchars($t('admin_settings_secret_two', 'Secret 2')) ?>"></div></div>
                    ...
                    <div class="col-md-6"><div class="glass-card p-4 border-success h-100"><div class="d-flex justify-content-between mb-3"><h5 class="text-success"><i class="fa-brands fa-bitcoin"></i> CryptoCloud</h5><div class="form-check form-switch"><input class="form-check-input" type="checkbox" name="crypto_enabled" value="1" <?= ($s['crypto_enabled']??0) ? 'checked' : '' ?>></div></div><input type="text" name="crypto_shop_id" value="<?= htmlspecialchars($s['crypto_shop_id'] ?? '') ?>" class="form-control bg-dark text-light border-secondary mb-2" placeholder="<?= htmlspecialchars($t('admin_settings_shop_id', 'Shop ID')) ?>"><input type="password" name="crypto_api_key" value="<?= htmlspecialchars($s['crypto_api_key'] ?? '') ?>" class="form-control bg-dark text-light border-secondary" placeholder="<?= htmlspecialchars($t('admin_settings_api_key', 'API Key')) ?>"></div></div>
                </div>
            </div>
