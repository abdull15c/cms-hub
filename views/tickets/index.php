<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-light"><?= $t('tickets_my', 'My Support Tickets') ?></h2>
        <a href="<?= BASE_URL ?>/tickets/new" class="btn btn-cyber"><?= $t('tickets_new', '+ New Ticket') ?></a>
    </div>
                ...
                <table class="table table-dark table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-secondary"><?= ucfirst($tkt['department']) ?></span></td>
                            ...
                            <td>
                                ...
                                ?>
                                <span class="badge <?= $cls ?>"><?= strtoupper(str_replace('_', ' ', $tkt['status'])) ?></span>
                            </td>
